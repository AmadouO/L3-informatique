...
int main(int argc, char ** argv) {
	...
	/*thread prod(test_put);
	thread conso(test_get);
	thread prod2(test_put);
	thread conso2(test_get);
	prod.join();
	conso.join();
	prod2.join();
	conso2.join();*/
